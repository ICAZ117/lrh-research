<template>
	<div
		class="auth-page min-vh-100 d-flex align-items-center justify-content-center py-5"
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							<div class="text-center mb-4">
								<h2 class="fw-bold">Register Staff Member</h2>
	...
	methods: {
		...
		async handleRegister() {
			...
			try {
				...
				const result = await authStore.registerStaffMember(
					this.formData.email,
