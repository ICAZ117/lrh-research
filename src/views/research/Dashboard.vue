<template>
  <div class="research-portal min-vh-100 py-5 mt-5" :class="{ 'dark': isDarkMode }">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Research Portal</h1>
        <router-link
          v-if="isStaff"
          to="/research-portal/new"
      ...
      <template v-if="isStaff">
        ...
        <div class="row g-4 mb-5">
          ...
          <div v-else v-for="project in allProjects" :key="project.id" class="col-md-6 col-lg-4">
        ...
        <div class="row g-4">
          ...
          <div v-else v-for="project in myProjects" :key="project.id" class="col-md-6 col-lg-4">
            <div class="card h-100">
              <div class="card-body">
                <h3 class="h5 card-title">{{ project.title }}</h3>
                <p class="card-text">{{ project.description }}</p>
